...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'places_place', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['places.Category']),
                      keep_default=False)
    ...
    models = {
        ...
        u'places.place': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['places.Category']"}),
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'db_index': 'True'}),
